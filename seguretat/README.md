...
> **Prerequisit**: Tots els serveis desplegats i estables.
...
```bash
sudo /opt/devops/snapshots/snapshot.sh pre-seguritat
```
...
```bash
sudo /opt/devops/snapshots/snapshot.sh post-seguritat
```
