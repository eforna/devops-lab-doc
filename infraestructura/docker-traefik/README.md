...
> **Prerequisit**: [Sistema base](../base/README.md) completat.
...
```bash
sudo /opt/devops/snapshots/snapshot.sh  # snapshot pre-docker-traefik
```
...
```bash
sudo /opt/devops/snapshots/snapshot.sh  # snapshot post-docker-traefik
```
...
- [x] Snapshot "post-docker-traefik" creat

**Següent**: [Serveis](../../serveis/README.md)
